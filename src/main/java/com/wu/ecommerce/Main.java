...
//				userService.addUser(new User("user2", "Siddhu", "Nawale", "nawalewadi",312414));
				...
				case 7:
					...
					userService.addUser(new User(userId, firstName, lastName, address, contactNumber));
					break;
				case 8:
				...
				case 11:
					...
					userService.updateUserById(userIdToChange,new User(userIdToChange, firstNameToChange, lastNameToChange, addressToChange, contactNumberToChange));
					break;
				default:
					scanner.close();
					break;
